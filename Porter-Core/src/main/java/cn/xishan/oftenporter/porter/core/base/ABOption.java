...
public class ABOption {
    ...
    private boolean canInVokeInner;
    ...
    public boolean isCanInVokeInner() {
        return canInVokeInner || portFunType == PortFunType.INNER;
    }

    public void setCanInVokeInner(boolean canInVokeInner) {
        this.canInVokeInner = canInVokeInner;
    }

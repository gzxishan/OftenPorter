...
public enum DuringType
{
    ...
    /**
     * 在执行接口函数后,
     * {@linkplain CheckPassable#willPass(OftenObject, DuringType, CheckHandle)}的{@linkplain CheckHandle#returnObj}为返回值。
     * <br>
    ...
    /**
     * 在执行接口函数抛出了异常时,
     * {@linkplain CheckPassable#willPass(OftenObject, DuringType, CheckHandle)}的{@linkplain CheckHandle#exCause}为异常信息。
     * <br>

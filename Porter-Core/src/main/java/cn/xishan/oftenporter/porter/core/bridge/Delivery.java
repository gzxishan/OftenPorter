...
public interface Delivery
{
    ...
    /**
     * 可以访问到所有可达的框架实例,无法访问{@linkplain PortFunType#INNER PortFunType.INNER}类型的接口。请求路径必须是fullPath（请求格式为":bridgeName/contextName/ClassTied/[funTied|restValue][=*=][?name1=value1&name2
     * =value2...]"），即加上bridgeName。
     *
     * @return
     */
    IBridge toAllBridge();

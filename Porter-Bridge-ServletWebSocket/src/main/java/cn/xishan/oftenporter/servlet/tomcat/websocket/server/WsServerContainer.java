 ...
 */
package cn.xishan.oftenporter.servlet.tomcat.websocket.server;
...
import cn.xishan.oftenporter.servlet.tomcat.InstanceManager;
import cn.xishan.oftenporter.servlet.tomcat.util.StringManager;
import cn.xishan.oftenporter.servlet.tomcat.websocket.WsSession;
import cn.xishan.oftenporter.servlet.tomcat.websocket.WsWebSocketContainer;
import cn.xishan.oftenporter.servlet.tomcat.websocket.pojo.PojoEndpointServer;
import cn.xishan.oftenporter.servlet.tomcat.websocket.pojo.PojoMethodMapping;
        ...
        implements ServerContainer
{
    ...
    private final Logger log = LoggerFactory.getLogger(WsServerContainer.class); // must not be static
    ...
    private volatile boolean enforceNoAddAfterHandshake =
            cn.xishan.oftenporter.servlet.tomcat.websocket.Constants.STRICT_SPEC_COMPLIANCE;
    ...
    public static WsServerContainer newInstance(ServletContext servletContext)
    {
        return new WsServerContainer(servletContext);
    }

    private WsServerContainer(ServletContext servletContext)
    {

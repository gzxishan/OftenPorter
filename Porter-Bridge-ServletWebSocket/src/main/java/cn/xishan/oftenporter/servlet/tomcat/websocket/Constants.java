 ...
 */
package cn.xishan.oftenporter.servlet.tomcat.websocket;
...
public class Constants {
    ...
    static final int DEFAULT_BUFFER_SIZE = Integer.getInteger(
            "cn.xishan.oftenporter.servlet.tomcat.websocket.DEFAULT_BUFFER_SIZE", 8 * 1024)
            .intValue();
    ...
    public static final String MAX_REDIRECTIONS_PROPERTY =
            "cn.xishan.oftenporter.servlet.tomcat.websocket.MAX_REDIRECTIONS";
    ...
    static final String DEFAULT_ORIGIN_HEADER_VALUE =
            System.getProperty("cn.xishan.oftenporter.servlet.tomcat.websocket.DEFAULT_ORIGIN_HEADER_VALUE");

    // Configuration for background processing checks intervals
    static final int DEFAULT_PROCESS_PERIOD = Integer.getInteger(
            "cn.xishan.oftenporter.servlet.tomcat.websocket.DEFAULT_PROCESS_PERIOD", 10)
            .intValue();

    public static final String WS_AUTHENTICATION_USER_NAME = "cn.xishan.oftenporter.servlet.tomcat.websocket.WS_AUTHENTICATION_USER_NAME";
    public static final String WS_AUTHENTICATION_PASSWORD = "cn.xishan.oftenporter.servlet.tomcat.websocket.WS_AUTHENTICATION_PASSWORD";
    ...
    static final boolean DISABLE_BUILTIN_EXTENSIONS =
            Boolean.getBoolean("cn.xishan.oftenporter.servlet.tomcat.websocket.DISABLE_BUILTIN_EXTENSIONS");
    static final boolean ALLOW_UNSUPPORTED_EXTENSIONS =
            Boolean.getBoolean("cn.xishan.oftenporter.servlet.tomcat.websocket.ALLOW_UNSUPPORTED_EXTENSIONS");

    // Configuration for stream behavior
    static final boolean STREAMS_DROP_EMPTY_MESSAGES =
            Boolean.getBoolean("cn.xishan.oftenporter.servlet.tomcat.websocket.STREAMS_DROP_EMPTY_MESSAGES");

    public static final boolean STRICT_SPEC_COMPLIANCE =
            Boolean.getBoolean("cn.xishan.oftenporter.servlet.tomcat.websocket.STRICT_SPEC_COMPLIANCE");

...
import cn.xishan.oftenporter.servlet.tomcat.util.threads.ThreadPoolExecutor;
...
public class AsyncChannelGroupUtil {
    ...
    private static final StringManager sm =
            StringManager.getManager(cn.xishan.oftenporter.servlet.tomcat.websocket.Constants.PACKAGE_NAME);

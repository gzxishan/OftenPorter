 ...
 *        5)source.doCommonSqlEnumerationQuery(sql,args)：会调用{@linkplain Common2#queryEnumeration(DBSource, AdvancedQuery, QuerySettings, WObject) Common2.queryEnumeration(DBSource, AdvancedQuery, null, WObject)}

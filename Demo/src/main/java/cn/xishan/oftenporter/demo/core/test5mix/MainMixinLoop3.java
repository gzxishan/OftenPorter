...
import cn.xishan.oftenporter.demo.core.test5mix.mixinloop.Root3Porter;
...
public class MainMixinLoop3
{
    public static void main(String[] args) {
        ...
        conf.setContextName("MainMixinLoop3");
        conf.getSeekPackages().addClassPorter(Root3Porter.class);
